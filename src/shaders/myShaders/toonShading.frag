...
uniform vec3 CameraPosition = Native.newVector3 (0.0, 0.0, 0.0); //!slider[(-100,-100,-100), (0, 0,0), (100,100,100)]
...
uniform vec3 LightPosition = Native.newVector3 (0.0, 0.0, 0.0); //!slider[(-100,-100,-100), (0, 0,0), (100,100,100)]
